...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	scale += 0.1 * sgn2;
	modelMatrix = glm::mat3(1);
	modelMatrix *= Transform2D::Translate(tx2, ty2) * Transform2D::Scale(scale, scale) * Transform2D::Translate(-tx2, -ty2) * Transform2D::Translate(tx2, ty2);
	//TODO create animations by multiplying current transform matrix with matrices from Transform 2D
	...
	rotation += 0.1;
	modelMatrix = glm::mat3(1);
	modelMatrix *= Transform2D::Translate(tx3 + 50, ty3 + 50) * Transform2D::Rotate(rotation) * Transform2D::Translate(-tx3 -50, -ty3 -50) * Transform2D::Translate(tx3 , ty3);
